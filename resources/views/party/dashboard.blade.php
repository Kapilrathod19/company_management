@extends('party.layout.main_layout')
@section('title', 'Party | Dashboard')
...
@section('scripts')
    <script>
        ...
        function loadSalesOrders() {
            ...
            $.ajax({
                url: '{{ route('party.get.sales.orders.by.item', ':id') }}'.replace(':id', itemId),
                type: 'GET',
                data: {
        ...
        function viewAllProcesses(salesOrderId, partNo, unitNo) {
            ...
            $.get(
                '{{ route('party.production.all.processes', ':id') }}'.replace(':id', salesOrderId), {
                    component_no: partNo,
                    unit_no: unitNo
                },
                function(data) {
