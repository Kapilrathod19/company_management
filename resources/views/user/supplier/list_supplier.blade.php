                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <div class="header-action">
                                @if (isset($permissions['supplier_PO']) && $permissions['supplier_PO']->add == 1)
                                    ...
                                    <tbody>
                                        @foreach ($suppliers as $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->remark ?? '' }}</td>
                                                <td>
                                                    @if (isset($permissions['supplier_PO']) && $permissions['supplier_PO']->edit == 1)
                                                        <a class="btn btn-primary btn-sm mb-2"
                                                            href="{{ route('supplier.edit', $item->id) }}" role="button">
                                                            <i class="bi bi-pencil-square"></i>
                                                        </a>
                                                    @endif
                                                    @if (isset($permissions['supplier_PO']) && $permissions['supplier_PO']->delete == 1)
