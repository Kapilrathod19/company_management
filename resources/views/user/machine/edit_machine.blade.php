...
@section('title', 'User | Edit Machine')
            ...
            <div class="row">
                <div class="col-sm-12 col-lg-12">
                    ...
                    <div class="card">
                        ...
                        {{-- Form --}}
                        <div class="card-body">
                            <form id="myform" action="{{ route('machine.update', $item->id) }}) }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="category" id="category" class="form-control">
                                            ...
                                            <option value="Manufacturing"
                                                {{ old('status', $item->category) == 'Manufacturing' ? 'selected' : '' }}>Manufacturing
                                            </option>
                                            <option value="Tools"
                                                {{ old('status', $item->category) == 'Tools' ? 'selected' : '' }}>
                                                Tools</option>
                                        </select>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="machine_no" id="machine_no" class="form-control"
                                            value="{{ old('machine_no', $item->machine_no) }}">
                                        <span class="text-danger"></span>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="machine_name" id="machine_name" class="form-control"
                                            value="{{ old('machine_name', $item->machine_name) }}">
                                        <span class="text-danger"></span>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="date" name="calibration_date" id="calibration_date"
                                            class="form-control" value="{{ old('calibration_date', $item->calibration_date) }}">
                                        <span class="text-danger"></span>
                                    </div>

                                    <div class="col-md-12 mb-3">
                                        <label for="remark" class="form-label">Remark</label>
                                        <textarea name="remark" id="remark" class="form-control" >{{ old('remark', $item->remark) }}</textarea>
                                        <span class="text-danger"></span>
                                    </div>
                                </div>
