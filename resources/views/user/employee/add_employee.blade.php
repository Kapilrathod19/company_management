...
@section('title', 'User | Add Employee')
            ...
            <div class="row">
                <div class="col-sm-12 col-lg-12">
                    ...
                    <div class="card">
                        ...
                        {{-- Form --}}
                        <div class="card-body">
                            <form id="myform" action="{{ route('employee.store') }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="contractor_name" id="contractor_name"
                                            class="form-control" value="{{ old('contractor_name') }}">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select name="category" id="category" class="form-control">
                                            ...
                                            <option value="Company" {{ old('category') == 'Company' ? 'selected' : '' }}>Company
                                            </option>
                                            <option value="Contract Supply" {{ old('category') == 'Contract Supply' ? 'selected' : '' }}>
                                                Contract Supply</option>
                                        </select>
                                        <span class="text-danger"></span>
                                    </div>
